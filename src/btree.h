...
class BTreeIndex {
 ...
 public:
   ...
   * @param isRoot
   */
  void insertHelper(Page* pagePointer, RIDKeyPair<int> entry,
                    PageKeyPair<int>* childEntry, int pageLevel, bool isRoot);
   ...
   * @param path
   */
  void search(PageId& foundPageID, PageId currPageId, const void* key,
